<template>
  <footer class="bg-white relative px-4 sm:px-8 lg:px-16 py-10 border-t border-gray-200">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">

      <p class="text-gray-600 text-sm">&copy; 2025 Jubayer Islam. All rights reserved.</p>
    ...
    <!-- Optional: Small note at bottom center -->
    <p class="text-gray-400 text-xs text-center mt-4">
      Designed & Developed by Jubayer Islam
    </p>
  </footer>
